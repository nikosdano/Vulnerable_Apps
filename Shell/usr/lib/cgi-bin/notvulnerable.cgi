...
echo ''
echo "<html><head><style>h1{text-align:center;}div{ background-color:gray; padding:10px; width:100%;} center{font-size:17px;}</style><title>Hello, Fosscomm!</title></head>"
